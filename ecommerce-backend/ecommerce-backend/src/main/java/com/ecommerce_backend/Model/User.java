...
public class User {
	...
	public User(Long id, String firstName, String lastName, String password, String email, String role, String mobile,
			List<Address> address, List<PaymentInformation> paymentInformations, List<Rating> rating,
	...
	public String toString() {
		return "User [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", password=" + password
				...
				+ ", paymentInformations=" + paymentInformations + ", rating=" + rating + ", rivews=" + rivews
				+ ", createdAt=" + createdAt + "]";
	}
